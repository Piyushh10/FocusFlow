...
val gradient3 = listOf(Color(0xFFdfbbde), Color(0xFF583e5a))
val gradient4 = listOf(Color(0xFFffb4ab), Color(0xFF93000a))
val gradient5 = listOf(Color(0xFF99f2c8), Color(0xFF1f4037))

val color1 = Color(0xFFFFFFFF)
val color2 = Color(0xFFFFF59D)
val color3 = Color(0xFFB2FF59)
val color4 = Color(0xFF80D8FF)
val color5 = Color(0xFFFF8A80)
val color6 = Color(0xFFD1C4E9)
val color7 = Color(0xFFFFF176)
val color8 = Color(0xFFBCAAA4)