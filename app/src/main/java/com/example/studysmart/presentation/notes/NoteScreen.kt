    ...
    Scaffold(
        floatingActionButton = {
            ExtendedFloatingActionButton(
                onClick = {
                    navigator.navigate("add_edit_note_screen")
                },
        ...
        Column(
            ...
            AnimatedVisibility(
                ...
                com.example.studysmart.presentation.components.OrderSection(
                ...
                items(state.notes) { note ->
                    NoteItem(
                        ...
                        modifier = Modifier
                            ...
                            .clickable {
                                navigator.navigate(
                                    "add_edit_note_screen?noteId=${note.id}&noteColor=${note.color}"
                                )
                            },
                        onDeleteClick = {
